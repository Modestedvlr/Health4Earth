...
Cette section permet d'explorer dynamiquement les tendances historiques de quelques pays du monde.

Les graphiques sont interactifs. Vous pouvez zoomer, et cliquer sur les noms des pays dans la légende à droite pour les masquer ou les isoler (double-clic).
...
On observe une divergence nette. Les pays de l'OCDE (USA, France, Allemagne) ont amorcé une décrue de leurs émissions. À l'inverse, les économies émergentes (Chine, Inde) montrent une croissance exponentielle liée à leur industrialisation.
...
Bien que la Chine émette le plus de CO2, sa courbe de mortalité liée à la pollution commence à stagner, signe de politiques sanitaires efficaces.
...
On note un rattrapage progressif des pays émergents vers les standards occidentaux (environ 80 ans).

#### Résilience :

Malgré la pollution, l'espérance de vie augmente globalement grâce aux progrès médicaux, prouvant que la technologie compense en partie les dégradations environnementales.


---
## Code Source :
Le code ayant généré ces graphiques est disponible dans l'onglet *Documentation*.