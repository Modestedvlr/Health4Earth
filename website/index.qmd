...
::: {.grid}
::: {.g-col-12 .text-center style="background-color: white; padding: 40px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); margin-bottom: 20px;"}
# Observatoire Health4Earth
<p style="font-size: 1.2em; color: #666;">
Visualisation et Prédiction de l'Impact Environnemental sur la Santé Publique
</p>
:::
:::

<!-- LE RESTE DE VOTRE CODE PYTHON NE CHANGE PAS -->
...
# --- BLOC 1 : CALCULS (Caché pour éviter les textes parasites) ---
import folium
import requests
...
# On empêche l'affichage intempestif des graphiques matplotlib
plt.ioff()

# Chargement des données
df = load_merged_data()

# Fonction de génération du graphique popup
...
# Liste des pays disponibles dans nos données
...
for feature in geo_data['features']:
    ...
    # On ajoute uniquement les pays qu'on connaît
